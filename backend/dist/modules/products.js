...
const products = [
    {
        ...
        price: 45.99,
        originalPrice: 59.99,
        description: 'Premium organic NPK fertilizer with balanced nutrients for all crops.',
    ...
    },
    {
        ...
        category: 'pesticide',
        price: 32.5,
        description: 'Eco-friendly broad-spectrum pesticide that protects crops from common pests.',
...
router.put('/:id', (req, res) => {
    ...
    const { name, category, price, description, usage, image, inStock, badge, originalPrice, } = req.body;
    if (name !== undefined)
        product.name = name;
